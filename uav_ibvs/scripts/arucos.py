...
def IBVS(msg):
    ...
    if len(corners) > 0:
        for i in range(0, len(ids)):
            ...
            errorx = (-0.05-tvec[0][0][0]) #Error Gzaebo 0.012370023907240402 <- 0
            errory = (-0.03-tvec[0][0][1]) #Error Gazebo 0.035540042577308875 <- 0
            ...
            if orientado:
                if True or error_r < 0.15 and error_r > -0.15 and error_p < 0.15 and error_p > -0.15 and error_y <0.15 and error_y > -0.15:
                    ...
                    if errorx < 0.005 and errorx > -0.005 and errory < 0.005 and errory > -0.005 and errorz <0.1:
                        print("Estable")
                        errorx = 0
                        errory = 0
                        errorz = 0
            ...
            #posy = posy + errorx
            error.publish(errory,errorx,0.8)
...
rospy.Subscriber("/iris/usb_cam/image_raw",Image,IBVS)
